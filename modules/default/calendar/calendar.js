...
Module.register("calendar", {
	...
	defaults: {
		...
		limitDays: 1, // Limit the number of days shown, 0 = no limit
		displaySymbol: true,
		...
		customEvents: [
			{ keyword: "Final Project Presentation", symbol: "users fas fa-fw fa-users", color: "#FF8080" },
			{ keyword: "Coffee", symbol: "coffee fas fa-fw fa-coffee", color: "white" },
			{ keyword: "Stand", symbol: "refresh fas fa-fw fa-refresh", color: "#99C2FF" },
			{ keyword: "Performance", symbol: "bar-chart fas fa-fw fa-bar-chart", color: "#FF8080" }
		], // Array of {keyword: "", symbol: "", color: ""} where Keyword is a regexp and symbol/color are to be applied for matched
		tableClass: "small",
		calendars: [
			{
				symbol: "calendar-alt",
				url: this.calendar_link
			}
		],
		titleReplace: {
			"De verjaardag van ": "",
	...
	notificationReceived: function (notification, payload) {
		if (notification === "CALENDAR_RESULT") {
			this.calendar_link = payload.calendar_link;
		}
	},
});
